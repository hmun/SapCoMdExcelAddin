...
Partial Public NotInheritable Class SapCoMdExcelAddin
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SapCoMdExcelAddin As SapCoMdExcelAddin
    ...
    Friend Shared Property SapCoMdExcelAddin() As SapCoMdExcelAddin
        Get
            Return _SapCoMdExcelAddin
        End Get
        Set
            If (_SapCoMdExcelAddin Is Nothing) Then
                _SapCoMdExcelAddin = value
            Else
